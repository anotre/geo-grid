  ...
  return (
    <div className="relative">
      ...
      > */}
        ...
        <Carousel autoplay>
          <div>
            <img className="carousel-img" src="./images/photo_2024-12-01_16-06-33.jpg" alt="" />
          </div>
          <div>
            {/* <h3 style={contentStyle}>2</h3> */}
            <img className="carousel-img" src="./images/photo_2024-12-01_16-08-03.jpg" alt="" />
          </div>
          <div>
            {/* <h3 style={contentStyle}>3</h3> */}
            <img className="carousel-img" src="./images/photo_2024-12-01_16-08-04.jpg" alt="" />
          </div>
          <div>
            {/* <h3 style={contentStyle}>4</h3> */}
            <img className="carousel-img" src="./images/photo_2024-12-01_16-08-05.jpg" alt="" />
          </div>
          <div>
            {/* <h3 style={contentStyle}>5</h3> */}
            <img className="carousel-img" src="./images/photo_2024-12-01_16-25-51.jpg" alt="" />
          </div>
          <div>
            {/* <h3 style={contentStyle}>6</h3> */}
            <img className="carousel-img" src="./images/photo_2024-12-01_16-26-19.jpg" alt="" />
          </div>
        </Carousel>
        </figure>
        {/* Play icon */}
